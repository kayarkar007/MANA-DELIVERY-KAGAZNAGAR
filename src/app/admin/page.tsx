        ...
        <div className="space-y-10 animate-in fade-in duration-500">
            <div className="space-y-2">
                <h1 className="text-2xl sm:text-4xl font-black text-gray-900 dark:text-white flex items-center gap-3">
                    <div className="p-2 sm:p-3 bg-blue-100 dark:bg-blue-900/50 text-blue-600 dark:text-blue-400 rounded-2xl">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
                {/* Revenue Card */}
                <div className="bg-gradient-to-br from-indigo-900 to-blue-900 text-white p-5 sm:p-6 rounded-3xl border border-blue-800 shadow-md flex flex-col justify-between col-span-2 relative overflow-hidden">
                    <div className="relative z-10">
                        <p className="text-blue-200 font-bold uppercase tracking-widest text-xs mb-2">Total Revenue Generated</p>
                    ...
                    <Link
                        ...
                        className="relative z-10 mt-6 flex items-center justify-between text-white font-bold hover:text-blue-200 transition-colors bg-white/10 px-4 py-3 rounded-xl border border-white/20 hover:bg-white/20 w-fit gap-4 backdrop-blur-sm text-sm"
                    >
                ...
                <div className="bg-white dark:bg-gray-900 p-4 sm:p-6 rounded-3xl border dark:border-gray-800 shadow-sm flex flex-col justify-between">
                    ...
                    <Link href="/admin/orders" className="mt-4 sm:mt-6 flex items-center justify-between text-blue-600 dark:text-blue-400 font-bold hover:text-blue-800 dark:hover:text-blue-300 transition-colors text-sm">
                ...
                <div className="bg-white dark:bg-gray-900 p-4 sm:p-6 rounded-3xl border dark:border-gray-800 shadow-sm flex flex-col justify-between">
                    ...
                    <Link href="/admin/categories" className="mt-4 sm:mt-6 flex items-center justify-between text-blue-600 dark:text-blue-400 font-bold hover:text-blue-800 dark:hover:text-blue-300 transition-colors text-sm">
                ...
                <div className="bg-white dark:bg-gray-900 p-4 sm:p-6 rounded-3xl border dark:border-gray-800 shadow-sm flex flex-col justify-between relative overflow-hidden">
                    ...
                    <Link href="/admin/live-tracking" className="relative z-10 mt-4 sm:mt-6 flex items-center justify-between text-blue-600 dark:text-blue-400 font-bold hover:text-blue-800 dark:hover:text-blue-300 transition-colors text-sm">
                        Monitor <ArrowRight className="w-4 h-4" />
                    </Link>
                    <div className="absolute right-0 bottom-0 text-blue-50 dark:text-blue-900/10 transform translate-x-1/4 translate-y-1/4 z-0">
                ...
                <div className="bg-white dark:bg-gray-900 p-4 sm:p-6 rounded-3xl border dark:border-gray-800 shadow-sm flex flex-col justify-between">
                    ...
                    <Link href="/admin/products" className="mt-4 sm:mt-6 flex items-center justify-between text-blue-600 dark:text-blue-400 font-bold hover:text-blue-800 dark:hover:text-blue-300 transition-colors text-sm">
                        Manage <ArrowRight className="w-4 h-4" />
                    </Link>
                </div>
                ...
                <div className="bg-white dark:bg-gray-900 p-4 sm:p-6 rounded-3xl border dark:border-gray-800 shadow-sm flex flex-col justify-between">
                    ...
                    <Link href="/admin/promo" className="mt-4 sm:mt-6 flex items-center justify-between text-blue-600 dark:text-blue-400 font-bold hover:text-blue-800 dark:hover:text-blue-300 transition-colors text-sm">
                        Manage <ArrowRight className="w-4 h-4" />
                    </Link>
                </div>
                ...
                <div className="bg-white dark:bg-gray-900 p-4 sm:p-6 rounded-3xl border dark:border-gray-800 shadow-sm flex flex-col justify-between">
                    <div>
                        ...
                        <h2 className="text-3xl sm:text-4xl font-black text-gray-900 dark:text-gray-100 flex items-center gap-2">
                            <Users className="w-7 h-7 text-blue-500" /> {stats.usersCount}
                        </h2>
                    </div>
                    <Link href="/admin/users" className="mt-4 sm:mt-6 flex items-center justify-between text-blue-600 dark:text-blue-400 font-bold hover:text-blue-800 dark:hover:text-blue-300 transition-colors text-sm">
                        Manage <ArrowRight className="w-4 h-4" />
                    </Link>
                </div>
            </div>
