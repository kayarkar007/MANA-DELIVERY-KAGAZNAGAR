    ...
    try {
        ...
        const html = `
            <div style="font-family: Arial, sans-serif; max-w: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eee; border-radius: 10px;">
                ...
                <p>Hi ${user.name},</p>
                <p>You recently requested to reset your password for your LocalU Delivery account. Click the button below to reset it:</p>
        ...
        await sendEmail(email, "Reset your LocalU Password", html);
